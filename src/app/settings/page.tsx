...
export default function SettingsPage() {
  ...
  const [notificationStyle, setNotificationStyle] =
    useState<NotificationStyle>("dock");
  ...
  const teamCodeInputsRef = Array(6)
    .fill(null)
  ...
  const handleTeamCodeKeyDown = (
    ...
    if (
      ...
      !teamCode[index] &&
      index > 0 &&
      teamCodeInputsRef[index - 1]?.current
    ) {
      teamCodeInputsRef[index - 1].current?.focus();
    }
  };
  ...
  const handleCreateTeamSubmit = async (e: FormEvent) => {
    ...
    if (finalTeamCode.length !== 6) {
      toast({
        ...
        description: "Team code must be 6 characters.",
        variant: "destructive",
      });
      return;
    }
    ...
    try {
      ...
      toast({
        ...
        description: `Team "${data.name}" is ready.`,
        icon: <CheckCircle2 className="h-5 w-5 text-primary" />,
      });
      setNewTeamName("");
          ...
          <CardContent className="space-y-8">
            <div>
              ...
              <div className="space-y-4">
                <Label htmlFor="theme-group" className="text-base">
                  Change Theme
                </Label>
                <RadioGroup
                  id="theme-group"
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 border rounded-lg">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => {
                      ...
                      handleSettingChange("notificationSoundEnabled", checked);
                    }}
                  />
                </div>
                <Label
                  htmlFor="notification-style-group"
                  className="text-base block pt-4"
                >
                ...
                <RadioGroup
                  ...
                  onValueChange={(value: NotificationStyle) => {
                    setNotificationStyle(value);
                    handleSettingChange("notificationStyle", value);
                  }}
              ...
              <div className="space-y-4 mt-2">
                <div className="flex items-center justify-between p-4 border rounded-lg">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Unlock team management and other experimental features.
                    </p>
                  </div>
                  <Switch
                    ...
                    onCheckedChange={(checked) => {
                      ...
                      handleSettingChange("advancedFeaturesEnabled", checked);
                    }}
                  />
                </div>
                  ...
                  >
                    ...
                    <DialogContent className="sm:max-w-md bg-card rounded-lg shadow-xl">
                      <DialogHeader>
                        ...
                        <DialogDescription>
                          Enter a name and a unique 6-character code for your
                          team.
                        </DialogDescription>
                      </DialogHeader>
                      <form
                          ...
                          <div className="flex justify-between gap-2 mt-1">
                            {teamCode.map((digit, index) => (
                              <Input
                                ...
                                value={digit}
                                onChange={(e) =>
                                  handleTeamCodeChange(index, e.target.value)
                                }
                                onKeyDown={(e) =>
                                  handleTeamCodeKeyDown(index, e)
                                }
