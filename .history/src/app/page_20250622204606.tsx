            ...
            {authMode === 'login' ? (
              <form onSubmit={handleCredentialsLogin} className="space-y-6 text-left">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <Input id="password-login" type={showPassword ? "text" : "password"} placeholder="••••••••" value={password} onChange={(e) => setPassword(e.target.value)} required className="bg-background border-input focus:ring-primary pr-10" />
              ...
              <form onSubmit={handleSignUp} className="space-y-4 text-left">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="password-signup" type="password" placeholder="••••••••" value={signupPassword} onChange={(e) => setSignupPassword(e.target.value)} required className="bg-background border-input focus:ring-primary" />
                </div>
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-grow container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        { (tasks.length === 0 || displayedTasks.length > 0 && displayedTasks.map(task )) && (
            <TaskList 
